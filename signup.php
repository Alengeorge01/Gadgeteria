<!DOCTYPE html>
        ...
        <form action="register.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="Email" placeholder=" Email Address" name="ead">
            </div>
            <div class="form-group">
              <label  for="Password">Password</label>
              <input type="password" class="form-control f1" id="Password" placeholder="Password" name="pass">
              <br>
              <label class="f2" for="Pass">Retype Password</label><br>
              <input type="password" class="form-control f1" id="Pass" placeholder="Retype Password" name="repass">
            </div>
